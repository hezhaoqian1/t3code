...
export const REFRESH_LOCAL_ENVIRONMENT_BEARER_TOKEN_CHANNEL =
  "desktop:refresh-local-environment-bearer-token";
...
export const FD_ACCOUNT_GET_STATE_CHANNEL = "desktop:fd-account-get-state";
export const FD_ACCOUNT_LOGIN_CHANNEL = "desktop:fd-account-login";
export const FD_ACCOUNT_LOGOUT_CHANNEL = "desktop:fd-account-logout";
export const FD_ACCOUNT_RELOAD_CHANNEL = "desktop:fd-account-reload";
export const FD_ACCOUNT_RETRY_REVOCATION_CHANNEL = "desktop:fd-account-retry-revocation";
export const FD_ACCOUNT_STATE_CHANGED_CHANNEL = "desktop:fd-account-state-changed";
export const FD_USAGE_GET_SUMMARY_CHANNEL = "desktop:fd-usage-get-summary";
export const FEISHU_CONNECTOR_GET_STATE_CHANNEL = "desktop:feishu-connector-get-state";
export const FEISHU_CONNECTOR_REFRESH_CHANNEL = "desktop:feishu-connector-refresh";
export const FEISHU_CONNECTOR_CONNECT_CHANNEL = "desktop:feishu-connector-connect";
export const FEISHU_CONNECTOR_DISCONNECT_CHANNEL = "desktop:feishu-connector-disconnect";
export const FEISHU_CONNECTOR_SET_ENABLED_CHANNEL = "desktop:feishu-connector-set-enabled";
export const FEISHU_CONNECTOR_STATE_CHANGED_CHANNEL = "desktop:feishu-connector-state-changed";
export const PRESENTATION_EXPORT_CHANNEL = "desktop:presentation-export";
export const PRESENTATION_OPEN_CHANNEL = "desktop:presentation-open";
export const PRESENTATION_READ_PROJECT_CHANNEL = "desktop:presentation-read-project";
export const PRESENTATION_WRITE_FILE_CHANNEL = "desktop:presentation-write-file";
