...
function getGnomeKeyringRemediationMessage(): string {
  return "方德 AI could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart 方德 AI.";
}

function getKWalletRemediationMessage(): string {
  return "方德 AI could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart 方德 AI.";
}
