...
// Stable id for the only Electron-owned local backend.
...
export interface DesktopBridge {
  ...
  // The only bootstrap is the Electron-owned primary loopback environment.
  getLocalEnvironmentBootstraps: () => readonly DesktopEnvironmentBootstrap[];
  getLocalEnvironmentBearerToken: () => Promise<string>;
  refreshLocalEnvironmentBearerToken: () => Promise<string>;
  getFdAccountState: () => Promise<FdAccountState>;
  loginFdAccount: (input: FdAccountLoginInput) => Promise<FdAccountLoginResult>;
  logoutFdAccount: () => Promise<FdAccountLogoutResult>;
  reloadFdAccount: () => Promise<FdAccountReloadResult>;
 ...
 * They represent stateful capabilities such as orchestration, terminal,
 * project, VCS, and provider operations for the primary environment.
 */
