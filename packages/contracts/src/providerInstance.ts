 ...
 *
 *   - `ProviderDriverKind` is the implementation kind selector. It picks which driver package
 ...
 *     instances of the same driver (e.g. `fd_deepseek_primary` + `fd_deepseek_staging`),
 ...
 * attributes. Mixed case remains permitted so external fork authors retain
 * reasonable freedom.
 */
