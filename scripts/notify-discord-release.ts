  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Fangde AI prerelease is available for nightly testers."
          : "A new Fangde AI latest release is available.",
...
).pipe(Command.withDescription("Post a Fangde AI release announcement to Discord."));
