...
assert.match(index, /scheduleStreamReconnect/);
assert.match(index, /stopStream/);
assert.match(index, /aboutToDisappear/);
assert.match(index, /connectStream\(false\)/);
...
assert.match(client, /modelNames/);
assert.match(client, /preview_url_missing/);
assert.match(client, /preview_url_unsafe/);
assert.match(client, /intentionallyClosed/);
